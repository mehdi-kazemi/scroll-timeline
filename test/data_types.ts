...
export const CHROME_DEFINITION: BrowserDefinition = {
  name: 'Chrome',
...
export const SAFARI_IOS_DEFINITION: BrowserDefinition = {
  name: 'Safari (iOS)',
...
export const SAFARI_MACOS_DEFINITION: BrowserDefinition = {
  name: 'Safari (macOS)',
  logo: 'https://unpkg.com/@browser-logos/safari-ios@1.0.15/safari-ios.svg',
  versions: (
    [
...
export const EDGE_DEFINITION: BrowserDefinition = {
  name: 'Edge',
...
export const FIREFOX_DEFINITION: BrowserDefinition = {
  name: 'Firefox',
...
export const SAMSUNG_INTERNET_DEFINITION: BrowserDefinition = {
...
export  const IE_DEFINITION: BrowserDefinition = {
